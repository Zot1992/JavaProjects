/*Написать графическую программу, выполняющую:
        1) рисующую красный прямоугольник на черном экране */
...
public class MainView extends View {
    ...
    protected void partialDisplay() { //Отображение подвижной и неподвижной фигуры
        ...
        glBegin(GL_LINES);// чертит линии без заливки
        ...
        /*glVertex2d(-0.25, -0.25); //код развернутого треугольника
        glVertex2d(0.0, 0.0);
        glVertex2d(-0.5, 0.0);*/

        glVertex2d(0.0, .8); // код звезды (неправильный)
        glVertex2d(0.6, -0.7);
        glVertex2d(-0.8, 0.1);
        glVertex2d(0.8, 0.1);
        glVertex2d(-0.6, -0.7);
